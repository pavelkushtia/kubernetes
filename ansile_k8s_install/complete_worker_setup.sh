...
# This script completes the installation of containerd and Kubernetes on new worker nodes
...
for worker in "${WORKERS[@]}"; do
    ...
    ssh sanzad@$worker "sudo $JOIN_COMMAND"
done
